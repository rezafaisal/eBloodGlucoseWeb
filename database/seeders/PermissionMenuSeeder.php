...
class PermissionMenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $menus = [
            ...
            ['id' => 3, 'title' => 'Users', 'url' => 'master.users.index', 'parent_id' => 2, 'icon' => 'UsersRound', 'sort' => 1],
            ['id' => 4, 'title' => 'Menus', 'url' => 'master.menus.index', 'parent_id' => 2, 'icon' => 'Logs', 'sort' => 2],
            ['id' => 5, 'title' => 'Roles', 'url' => 'master.roles.index', 'parent_id' => 2, 'icon' => 'UserRoundCog', 'sort' => 3],
        ];
